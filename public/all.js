+ function(e, n, t, r) {
    + function(i, o, a, c, s, u) {
                    ...
                    switch (e) {
                        ...
                        case 38:
                            var i = a[H.i],
                                o = 0,
                                s = 0;
                            u[i] && (o = u[i][0], s = u[i][1]), n = m(H, {
                                x: H.x + o,
                                y: H.y + s,
                                i: i
                            }), n.x = r.min(n.x, 10 - c[n.i]), n.x = r.max(n.x, 0)
                    }
                    H = g(n) || H, E(), k()
                }
                if (e in {
        ...
        function g(e) {
            if (!o[e.i].some(function(n, t) {
                    if (t = f(t, e.x, e.y), n && (t >= 200 || i[t])) return 1
                })) return e
        }

        function E() {
            w = i.slice(), o[H.i].map(function(e, n) {
        ...
        function h() {
            ...
            if (!H.c) return K = 1, C = (new Date - C) / 1e3 << 0, void n(function() {
                D(O, I, x, C)
            });
            O += 10 * I, H = A, A = m(), i = w;
        ...
        function k() {
            var e = "\n\r",
                ...
                c = d(a, 2),
                s = d(" ", 80) + e;
            if (P) return n = d(" ", 19), L = [-58917640, -942919668, 858981133, -2096247688, -1023360221, 53509168, -858816512].map(function(e) {
                return (d("0", 10) + (e >>> 0).toString(2)).substr(-32)
            }).join("").substr(0, 210).split("").map(function(e) {
                return [" ", a][e]
            }).join("").match(/.{1,42}/g).join(n + e + n), void(L = d(s, 8) + n + L + n + e + d(s, 4) + d(" ", 33) + "PRESS ANY KEY" + d(" ", 34) + e + d(s, 7));
            L = w.map(function(e) {
                return [" .", c][e]
            }).join("").match(/.{20}/g).join(i), L = t + L + i + d("=", 20) + r + n + "  " + d("\\/", 10) + "  " + n;
            var u = x.toString();
            u = "ROWS HIT:" + d(" ", 15 - u.length) + u, L = u + l(24);
            var f = O.toString().reverse().match(/.{1,3}/g).join(" ").reverse();
            f = "SCORE:" + d(" ", 18 - f.length) + f, L = l(0, 80) + f + l(104), L = l(0, 160) + "LEVEL:" + d(" ", 17) + I + l(184), o[A.i].map(function(e, n) {
                n = 80 * (10 + 2 * n / 8 << 0) + 20 + 2 * n % 8, e && (L = l(0, n) + c + l(n + 2))
            }), L = l(0, 138) + "UP ARROW: ROTATE" + l(154), L = l(0, 216) + "DOWN ARROW: SOFT DROP" + l(237), L = l(0, 298) + "SPACEBAR: HARD DROP" + l(317), L = l(0, 380) + "ESC, P: PAUSE" + l(393), U && (L = l(0, 757) + "PAUSED" + l(763)), K && (L = l(0, 756) + "TRY AGAIN?" + l(766), L = l(0, 836) + "   Y/N    " + l(846)), L = L.match(/.{1,80}/g).join(e), L = s + L + e + d(s, 2), N(L)
        }
    ...
    }("0".repeat(200).split("").map(e), [785, 23, 547, 116, 51, 114, 305, 39, 562, 15, 4369, 99, 306, 54, 561, 802, 113, 275, 71].map(function(n) {
...
}(parseFloat, setTimeout, clearTimeout, Math), String.prototype.reverse = function() {
    ...
    function t(e, n) {
        function t(e) {
            ...
            t.open("GET", u + e, !0), t.responseType = "arraybuffer", t.onload = function() {
    ...
    var r, i, o, a, c, s = [],
        u = "./public/";
    r = new(window.AudioContext || window.webkitAudioContext), t(["key1.ogg", "key2.ogg", "key3.ogg", "key4.ogg"], function(e) {
        s.push(e)
    }), t("space.ogg", function(e) {
        i = e
    }), t("ambience.ogg", function(e) {
        a = n(o = e, !0)
    }), t("beep.ogg", n), document.getElementById("mute-sound").addEventListener("click", function(e) {
    ...
    function c(i, c, s) {
        ...
        function d() {
            ...
            if (e && !(e.length > 10)) {
                ...
                n.open("POST", "https://tetris-tiurin.rhcloud.com/api/scores", !0), n.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), n.onreadystatechange = function() {
                    n.readyState == XMLHttpRequest.DONE && 200 == n.status && (o(), u(), c())
                }, n.send(Object.keys(i).map(function(e) {
                    return e + "=" + i[e]
                }).join("&"));
        ...
        try {
            ...
            p.push({
                t: l,
                s: i.score
            }), localStorage.setItem("tetrisScore", JSON.stringify(p));
    ...
    function s(i) {
        ...
        if ("block" !== c.style.display) {
            ...
            d.open("GET", "https://tetris-tiurin.rhcloud.com/api/scores", !0), d.onload = function(r) {
                var i = JSON.parse(r.target.response);
                "ok" === i.status && (s(), t("score-leaders").innerHTML = i.scores.map(function(t) {
    ...
    function f() {
        ...
        var t, r;
        return TETRIS.upause(), setTimeout(function() {
    ...
    n.rel = "stylesheet", n.href = "./public/styles.css", e.body.appendChild(n)
}(document);
